...
if( defined( 'PIXXIS_BACKEND_ADMIN_HTML_PHP' ) == true )
{
  return;
}
 ...
 */
define( 'PIXXIS_BACKEND_ADMIN_HTML_PHP', 1 );


/**
*  HTML_PIXXIS is the html backend class from com_PIXXIS
*
* @package PIXXIS
* @subpackage Backend
**/
class PixxisBackendHtml
{
...
-->
    ...
    <form action="index.php" method="post" name="adminForm">
		...
		<tr>
			<th class="edit" rowspan="2" nowrap><?php echo JText::_( 'PIXXIS_USER_ADMIN' );?></th>
	  </tr>
	  </table>
	  ...
	  <table class="adminlist">
		<tr>
			...
			<th class="title"><?php echo JText::_( 'PIXXIS_USERID' );?></th>
			<th class="title"><?php echo JText::_( 'PIXXIS_NAME' );?></th>
			<th class="title"><?php echo JText::_( 'PIXXIS_USERNAME' );?></th>
			<th class="title"><?php echo JText::_( 'PIXXIS_ALLOWED_SEND_SMS' );?></th>
			<th class="title"><?php echo JText::_( 'PIXXIS_CREDITS' );?></th>
	  </tr>
		<?php
		$k = 0;
		 $allow = false;
		...
		<td style="text-align: center;">
			<div id="assinatura">
				<div style="float:left; width: 100%; text-align: center;">
					<br /><img src="http://www.pixxis.com.br/imagens/logo-pixxis-joomla.png" alt="SMS PIXXIS - Pixxis Tecnologia" title="SMS PIXXIS - Pixxis Tecnologia" width="250" height="35" />
				</div>
			</div>
		</td>
	</tr>
...
?>
    <table class="adminheading">
           <tr>
	       <th class="cpanel" rowspan="2" nowrap>SMS PIXXIS</th>
	  </tr>
   </table>
				...
				<div style="float:left;">
					<div class="icon">
						<a href="index.php?option=com_pixxis&amp;act=global">
							...
							<?php echo JText::_( 'PIXXIS_GLOBAL_SETTINGS' ); ?> </a>
					</div>
				</div>
			</div>
			<div id="cpanel">
				<div style="float:left;">
					<div class="icon">
						<a href="index.php?option=com_pixxis&amp;act=about">
							...
							<?php echo JText::_( 'PIXXIS_SHOW_ABOUT' ); ?> </a>
					</div>
				</div>
			</div>
		  <div id="cpanel">
				<div style="float:left;">
					<div class="icon">
						<a href="index.php?option=com_pixxis&amp;act=prereq">
							...
							<?php echo JText::_( 'PIXXIS_PREREQ_CHECK' ); ?> </a>
					</div>
				</div>
		  </div>
			</div>
...
function editUser(&$row, &$PixxisRow)
  ...
  ?>
		...
		<table class="adminheading">
		<tr>
			<th class="edit" rowspan="2" nowrap><?php echo $row->name .' '. JText::_( 'PIXXIS_EDIT' ); ?></th>
	  </tr>
	  </table>
	  ...
	  <table cellspacing="0" cellpadding="0" width="100%">
		<tr valign="top">
    	  ...
    	  <tr>
    	    <td width="50"><?php echo JText::_( 'PIXXIS_PHONENUMBER' );?></td>
    	    <td><input type="text" name="number" value="<?php echo $PixxisRow->number; ?>" size="50" /></td>
    	  </tr>
    	  <tr>
    	    <td><?php echo JText::_( 'PIXXIS_COMMENT' ); ?></td>
    	    <td><input type="text" name="comment" value="<?php echo $PixxisRow->comment ?>" size="50" /></td>
    	  </tr>
    	  <tr>
    	    <td><?php echo JText::_( 'PIXXIS_CREDITS' );?></td>
    	    <td><input type="text" name="credits" value="<?php echo $PixxisRow->credits ?>" size="50" /></td>
    	  </tr>
    	  </table>
    	</td>
    </tr>
...
function showAdvertisment(&$ad)
  ...
  ?>
   <form action="index.php" method="post" name="adminForm">
	 ...
	 <table class="adminheading">
	<tr>
			<th class="edit" rowspan="2" nowrap><?php echo JText::_('PIXXIS_ADVERTISMENT' ); ?></th>
	  </tr>
     </table>
...
?>
	  ...
	  <table class="adminlist">
	    <tr>
			...
			siga a <a href="index.php?option=com_pixxis&amp;act=about" target="_self">orientação</a> na area da ajuda. Somente dessa maneira conseguiremos enxergar que o seu acesso ocorre pelo componente SMS PIXXIS e assim propiciar meios para que este componente possa continuar melhorando.
			</div>
			<br />&nbsp;Para adicionar ou substituir novos gateways, veja mais informa&ccedil;&otilde;es na se&ccedil;&atilde;o: "<a href="index.php?option=com_pixxis&amp;act=about" target="_self">AJUDA - Gateways</a>".<br />
		</tr>
		<tr>
			<th width="5">#</th>
			<th width="5">
			...
			<th class="title"><?php echo JText::_( 'PIXXIS_PROVIDER' );?></th>
			<th class="title"><?php echo JText::_('PIXXIS_ACTIV' );?></th>
	    </tr>
		<?php
		$k = 0;
		$allow = false;
...
function editProvider(&$row, &$provider)
  ...
  ?>
     <form action="index.php" method="post" name="adminForm">
		...
		<table class="adminheading">
		<tr>
			<th class="edit" rowspan="2" nowrap="nowrap"><?php echo JText::_( 'PIXXIS_EDIT' ) .' provedor '. $row->name ;?></th>
	  </tr>
	  </table>
    	  		...
    	  		<table width="100%" class="adminlist">
    				<tr>
    					<th colspan="2" align="left" class="title">
    						<?php echo JText::_( 'PIXXIS_DETAILS' ) ;?></th>
          			</tr>
<?php
          ...
          <td width="190" align="right">
			...
			:&nbsp;&nbsp;
			  ...
			  <td align="left">
			  	<?php
				if ($key == 'username') {
					echo '<input type="text" name="'.$key.'" value="'.$val.'"> OBS.: sua conta no gateway deve ser criada com os 4 primeiros caracteres igual a "pixx". <a href="index.php?option=com_pixxis&amp;act=about" target="_self">Veja detalhes </a>';
				} else {
...
?>
		...
		<table class="adminheading">
		<tr>
			<th class="edit" rowspan="2" nowrap="nowrap"><?php echo JText::_( 'PIXXIS_LOADLIST' ); ?></th>
	  </tr>
	  </table>
	  ...
	  <table cellspacing="0" cellpadding="0" width="100%">
		<tr valign="top">
		  ...
		  <tr>
			<td><b><?php echo JText::_( 'PIXXIS_SELECTED_USER' );?></b><br/>
			<ul>
			<?php
				foreach( $cid as $user ){
					$u = new PixxisUser( $user );
          ...
          <tr>
          	<td>
          		<b>
          			<?php echo JText::_( 'PIXXIS_NEW_CREDITS' );?>:
          		</b>
          		<input type="text" name="credits" value="0" size="4">
          		<input type="submit" name="button" value="<?php echo JText::_( 'PIXXIS_SAVE' );?>">
          	</td>
          </tr>
...
?>
	...
	/**
	 * Show some links and statistics about com_pixxis
	 */
	function showAbout()
	{
	?>
			<table class="adminheading">
				<tr>
					<th class="edit" rowspan="2" nowrap="nowrap"><?php echo JText::_( 'PIXXIS_SHOW_ABOUT' ); ?></th>
	  			</tr>
	  		</table>
			...
			<table width="90%" border="0" align="center" cellpadding="6" cellspacing="0">
				<tr>
					<td width="50%" align="left" valign="top">
						<p><a href="http://www.pixxis.com.br" target="_blank" alt="PIXXIS Tecnologia">
						  <img src="http://www.pixxis.com.br/imagens/logo-pixxis-topoParaWeb.png" alt="SMS PIXXIS - Desenvolvido por PIXXIS Tecnologia" border="0"></a></p>
						<p>&nbsp; </p></td>
...
foi baseado no <a href="http://mysms.joomlacoder.de" target="_blank">MySMS</a>.</td>
				...
				<tr>
					<td align="left" valign="top" bgcolor="#EFEFEF">
						<h3>Obrigado por usar o SMS PIXXIS</h3>
						
						Veja alguns links interessantes ligados a este projeto:
						<ul>
							<li>
								PIXXIS Tecnologia: <a href="http://www.pixxis.com.br/" target="_blank" alt="PIXXIS Tecnologia">http://www.pixxis.com.br</a>							</li>
							<li> 
			        ...
			        <p align="right">SMS PIXXIS utiliza algumas imagens sob licenca GPL de <a href="http://www.everaldo.com/crystal/" target="_blank"> Everaldo - Crystal </a></p>		            </td>
				</tr>
				<tr>
				  <td colspan="3" align="left" valign="top"><h3><br />
			          O COMPONENTE SMS PIXXIS </h3>
				    ...
				    <p>Através de uma parceria com o Provedor de Serviços SMS ByJG este componente tomou vida e, por padr&atilde;o, o SMS PIXXIS vem configurado para trabalhar  com o gateway ByJG mas pode ser alterado por sua conta e risco para novos gateways (nacionais ou estrangeiros) ou atrav&eacute;s de contrata&ccedil;&atilde;o de servi&ccedil;o de personaliza&ccedil;&atilde;o junto &agrave; <a href="http://www.pixxis.com.br/" target="_blank">PIXXIS TECNOLOGIA</a> a ser or&ccedil;ado de acordo com suas necessidades.      </p>
				    <br />
				    <h3>AJUDA PARA USAR O SMS PIXXIS </h3>
				    <h4>1 -  Configura&ccedil;&otilde;es Iniciais </h4>
				    <p>Ao instalar o componente &eacute; necess&aacute;rio fazer alguns ajustes. Vamos ver agora atrav&eacute;s de um passo-a-passo as primeiras configura&ccedil;&otilde;es para deixar o seu SMS PIXXIS funcionando.  </p>
				    <p><strong>2 - Administrar Provedor</strong></p>
				    <p>Por padr&atilde;o, o SMS PIXXIS est&aacute; configurado para trabalhar somente com um gateway que tem cobertura dentro do territ&oacute;rio brasileiro atuando com as principais operadoras (Tim, Oi, Vivo e Claro) e que trabalhe com formas de pagamento em moeda brasileira (R$). Este foi o objetivo de sua cria&ccedil;&atilde;o: um sistema que tenha sua interface em portugu&ecirc;s do Brasil e que tenha formas de recarga em moeda do Brasil.</p>
				    <p><span class="style1">Nota:</span> A PIXXIS TECNOLOGIA oferece o servi&ccedil;o de personaliza&ccedil;&atilde;o e desenvolvimento para este produto, consulte atrav&eacute;s do e-mail <em><strong>sms@pixxis.com.br</strong></em>.    </p>
				    <p>Para chegar a tela de <strong>Administrar Provedor</strong> v&aacute; ao menu Componentes -&gt;  SMS PIXXIS -&gt; Administrar Provedor. </p>
				  ...
				  <td colspan="3" align="left" valign="top"><h3>Solicitar Altera&ccedil;&otilde;es ou Novas Funcionalidades </h3>
				    ...
				    <table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC">
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top">Inserido informa&ccedil;&atilde;o de saldo de cr&eacute;ditos capturado autom&aacute;ticamente junto ao provedor (v&aacute;lido somente para o provedor padr&atilde;o do SMS PIXXIS   . </td>
                      </tr>
                      <tr>
	...
	?>
			<table class="adminheading">
				<tr>
					<th class="edit" rowspan="2" nowrap="nowrap"><?php echo JText::_( 'PIXXIS_PREREQ_CHECK' ); ?></th>
	  			</tr>
	  		</table>
	<?php
