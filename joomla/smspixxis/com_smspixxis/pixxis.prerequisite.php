...
if( defined( 'PIXXIS_BACKEND_PREREQUISITE_PHP' ) == true )
{
  return;
}
 ...
 */
define( 'PIXXIS_BACKEND_PREREQUISITE_PHP', 1 );


class PixxisPrerequisite
{
	/**
	...
	function Check()
	{
		$methods = get_class_methods( 'PixxisPrerequisite' );
		$result  = array();
	...
	function CheckFopenWrapper()
	{
		...
		$desc = 'php.ini - allow_url_fopen - pixxis';
