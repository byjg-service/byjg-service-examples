...
* SMS PIXXIS é um software livre. Esta versão pode ter sido modificado nos termos da 
...
if( defined( 'PIXXIS_PROVIDER_PIXXIS_PHP' ) == true )
{
  return;
}
 ...
 */
define( 'PIXXIS_PROVIDER_PIXXIS_PHP', 1 );
 ...
 /**
   ...
   */
      ...
      {      	
		...
		$permission = PIXXIS::checkoutUser($usuario);
	  ...
	  /*
	  * funcao que recupera informa�ao de saldo junto ao SMS Gateway - only SMS PIXXIS
	  */
