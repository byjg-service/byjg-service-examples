...
if( defined( 'PIXXIS_BACKEND_TOOLBAR_PHP' ) == true )
{
  return;
}
 ...
 */
define( 'PIXXIS_BACKEND_TOOLBAR_PHP', 1 );

$html = dirname( __FILE__ ) . '/toolbar.pixxis.html.php' ;
require_once( $html );
